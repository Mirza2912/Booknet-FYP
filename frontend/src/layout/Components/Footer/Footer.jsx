          ...
          <div className="grid grid-cols-1 gap-8 px-4 py-6 lg:py-8 md:grid-cols-3">
            <div className="mx-5">
              ...
              <p className="text-white text-md">
                BookNest - worldwide Book and Stationary store since 2021. We
                sell over 2000+ Category products on our web-site.
              </p>
              <div className="my-7">
                {/* <img src={footerLogo} className="w-13 h-10" alt="" /> */}
                <p className="text-xl text-white font-semibold">BookNest</p>
              </div>
            ...
            <div className="mx-5">
              <div>
                ...
                <p className="text-3xl text-white font-semibold">BookNest</p>
              </div>
